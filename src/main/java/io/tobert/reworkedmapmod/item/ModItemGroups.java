...
/**
 * Class for storing and creating custom item groups
 */
public class ModItemGroups {
    ...
    public static final ItemGroup CUSTOM_ITEM_GROUP = FabricItemGroup.builder().icon(()->new ItemStack(ModItems.EVIL_DIAMOND)).displayName(Text.translatable("itemgroup.reworkedmapmod.custom_item_group")).build();
}
